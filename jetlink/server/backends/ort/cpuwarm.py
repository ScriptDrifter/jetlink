...
busy core took a paced run from 29.4 ms mean and 41.3 ms p99 to 27.0 and
28.9 (1,200 frames, 2026-09-25). The iPhone build does the same
(ios/JetlinkKit, CPUKeepWarm.swift).
