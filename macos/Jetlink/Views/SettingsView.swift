...
struct ServerSettingsView: View {
  ...
  static func backendCaption(_ backend: BackendChoice) -> String {
    ...
    case .ane:
      "Vision on the Neural Engine, the policy on the GPU, both kept ready between frames: about 28 ms a frame at the comma's 20 Hz on an M1 Pro, measured over TCP, not yet over USB or in a car. Preparing takes about 40 seconds the first time."
    case .tinygrad:
